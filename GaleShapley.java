...
public class GaleShapley {
	 ...
	 * 
	 * @param left
	 * preference lists for left, i.e., <code>left[i][j]</code> is the rank of
	 * right <code>j</code> in left <code>i</code>'s preference list.
	 * 
	 * @param right
	 * preference lists for right, i.e., <code>right[i][j]</code> is the rank
	 * of left <code>j</code> in right <code>i</code>'s preference list.
	 * 
	 * @return
	 * stable matching for given instance of stable matching problem.
	 * 
	 * @throws IllegalArgumentException
	 * if <code>left</code> and <code>right</right> are not the preference
	 * lists for an instance of the stable matching problem.
	 */
